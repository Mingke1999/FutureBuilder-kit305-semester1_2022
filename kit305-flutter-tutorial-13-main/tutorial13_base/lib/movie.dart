...
class Movie
{
  ...
  Movie({required this.id, required this.title, required this.year, required this.duration, this.image});
...
class MovieModel extends ChangeNotifier {
  ...
  CollectionReference moviesCollection = FirebaseFirestore.instance.collection('movie');
  bool loading = false; //if still fetching date
  MovieModel() {fetch();}
